  ...
  const projects = [
    {
        ...
        About: "Built a serverless OCR pipeline on Modal GPUs, with a FastAPI gateway and a React frontend for fast, effortless expense splitting. Currently improving extraction quality by moving off DONUT to newer lightweight vision-language models — Qwen3-VL-4B on a pinned L4 — which lets me pull the store and date the old CORD schema couldn't reach, and cross-check the receipt's printed total against the line-item sum to catch missed rows. Next up: benchmarking accuracy on real phone photos and re-measuring cold-start and parse latency after the model swap.",
        TechStack: "Modal • Python • FastAPI • React • Qwen3-VL • Transformers",
        CTA1: "View Repo",
